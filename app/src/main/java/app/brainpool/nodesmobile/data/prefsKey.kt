...
//    const val PROPERTIES = "PROPERTY"
    ...
    const val NIGHT_MODE_STRING: String = "NIGHT_MODE_STRING"
    const val DATA_USAGE: String = "DATA_USAGE"
    const val DATA_USAGE_STRING: String = "DATA_USAGE_STRING"
    const val DEFAULT_MAP: String = "DEFAULT_MAP"
    const val DEFAULT_MAP_STRING: String = "DEFAULT_MAP_STRING"
    const val DEVICE_TRACKING: String = "DEVICE_TRACKING"
}
